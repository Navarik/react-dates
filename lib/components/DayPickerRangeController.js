  ...
  _createClass(DayPickerRangeController, [{
    ...
    value: function () {
      function onPrevMonthClick() {
        ...
        var prevMonthVisibleDays = (0, _getVisibleDays2['default'])(newCurrentMonth, numberOfMonths, enableOutsideDays, orientation === _constants.VERTICAL_SCROLLABLE);

        var newVisibleDays = {};
        var newPrevMonthVisibleDays = {};
        Object.keys(prevMonthVisibleDays).forEach(function (testKey) {
          if (visibleDays[testKey]) {
            newVisibleDays[testKey] = visibleDays[testKey];
          } else {
            newPrevMonthVisibleDays[testKey] = prevMonthVisibleDays[testKey];
          }
        });

        this.setState({
          currentMonth: newCurrentMonth,
          visibleDays: (0, _object2['default'])({}, newVisibleDays, this.getModifiers(newPrevMonthVisibleDays))
        }, function () {
    ...
    value: function () {
      function onNextMonthClick() {
        ...
        var nextMonthVisibleDays = (0, _getVisibleDays2['default'])(newCurrentMonth, numberOfMonths, enableOutsideDays, orientation === _constants.VERTICAL_SCROLLABLE);

        var newVisibleDays = {};
        var newNextMonthVisibleDays = {};
        Object.keys(nextMonthVisibleDays).forEach(function (testKey) {
          if (visibleDays[testKey]) {
            newVisibleDays[testKey] = visibleDays[testKey];
          } else {
            newNextMonthVisibleDays[testKey] = nextMonthVisibleDays[testKey];
          }
        });

        this.setState({
          currentMonth: newCurrentMonth,
          visibleDays: (0, _object2['default'])({}, newVisibleDays, this.getModifiers(newNextMonthVisibleDays))
        }, function () {
    ...
    value: function () {
      function onPrevYearClick() {
        var _props8 = this.props,
            onPrevYearClick = _props8.onPrevYearClick,
        ...
        var newCurrentMonth = currentMonth.clone().subtract(12, 'months');
        var prevMonthVisibleDays = (0, _getVisibleDays2['default'])(newCurrentMonth, numberOfMonths, enableOutsideDays, orientation === _constants.VERTICAL_SCROLLABLE);
    ...
    value: function () {
      function onNextYearClick() {
        var _props9 = this.props,
            onNextYearClick = _props9.onNextYearClick,
        ...
        var newCurrentMonth = currentMonth.clone().add(12, 'months');
        var nextMonthVisibleDays = (0, _getVisibleDays2['default'])(newCurrentMonth, numberOfMonths, enableOutsideDays, orientation === _constants.VERTICAL_SCROLLABLE);
    ...
    value: function () {
      function addModifier(updatedDays, day, modifier) {
        ...
        var _state8 = this.state,
            firstVisibleMonth = _state8.currentMonth,
    ...
    value: function () {
      function deleteModifier(updatedDays, day, modifier) {
        ...
        var _state9 = this.state,
            firstVisibleMonth = _state9.currentMonth,
            visibleDays = _state9.visibleDays;
    ...
    value: function () {
      function render() {
        ...
        var _state10 = this.state,
            currentMonth = _state10.currentMonth,
            phrases = _state10.phrases,
            visibleDays = _state10.visibleDays;
