...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)((0, _object2['default'])({}, _reactWithStyles.withStylesPropTypes, {
  ...
  dateString: _propTypes2['default'].string,
...
function SingleDatePickerInput(_ref) {
  ...
  return _react2['default'].createElement(
    ...
    showClearDate && _react2['default'].createElement(
      'button',
      _extends({}, (0, _reactWithStyles.css)(styles.SingleDatePickerInput_clearDate, small && styles.SingleDatePickerInput_clearDate__small, !customCloseIcon && styles.SingleDatePickerInput_clearDate__default, !displayValue && !dateString && styles.SingleDatePickerInput_clearDate__hide), {
        type: 'button',
