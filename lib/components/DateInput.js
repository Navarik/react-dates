...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)((0, _object2['default'])({}, _reactWithStyles.withStylesPropTypes, {
  ...
  inputIndex: _propTypes2['default'].number,
  ...
  _createClass(DateInput, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        if (this.state.dateString && nextProps.displayValue || // actual date set
    ...
    value: function () {
      function render() {
        ...
        var tabIndexProp = tabIndex ? { tabindex: tabIndex } : {};
