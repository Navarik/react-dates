  ...
  _createClass(DayPickerSingleDateController, [{
    ...
    value: function () {
      function onPrevMonthClick() {
        ...
        var newVisibleDays = {};
        Object.keys(visibleDays).sort().slice(0, numberOfMonths + 23).forEach(function (month) {
          newVisibleDays[month] = visibleDays[month];
        });

        var prevMonth = currentMonth.clone().subtract(13, 'month');
    ...
    value: function () {
      function onNextMonthClick() {
        ...
        var nextMonth = currentMonth.clone().add(numberOfMonths + 12, 'month');
    ...
    value: function () {
      function onPrevYearClick() {
        var _props4 = this.props,
            onPrevYearClick = _props4.onPrevYearClick,
        ...
        var newVisibleDays = {};
        Object.keys(visibleDays).sort().slice(0, numberOfMonths + 12).forEach(function (month) {
          newVisibleDays[month] = visibleDays[month];
        });

        var prevMonth = currentMonth.clone().subtract(24, 'months');
        var prevMonthVisibleDays = (0, _getVisibleDays2['default'])(prevMonth, 12, enableOutsideDays, true);
    ...
    value: function () {
      function onNextYearClick() {
        var _props5 = this.props,
            onNextYearClick = _props5.onNextYearClick,
        ...
        var newVisibleDays = {};
        Object.keys(visibleDays).sort().slice(12).forEach(function (month) {
          newVisibleDays[month] = visibleDays[month];
        });

        var nextMonth = currentMonth.clone().add(numberOfMonths + 12, 'months');
        var nextMonthVisibleDays = (0, _getVisibleDays2['default'])(nextMonth, 12, enableOutsideDays, true);
    ...
    value: function () {
      function render() {
        ...
        var _state9 = this.state,
            currentMonth = _state9.currentMonth,
