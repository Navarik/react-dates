...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)((0, _object2['default'])({}, _reactWithStyles.withStylesPropTypes, {
  ...
  startDateString: _propTypes2['default'].string,
  endDate: _propTypes2['default'].string,
  endDateString: _propTypes2['default'].string,
...
function DateRangePickerInput(_ref) {
  var startDate = _ref.startDate,
      ...
      startDateName = _ref.startDateName,
      startDatePlaceholderText = _ref.startDatePlaceholderText,
      startDateTabIndex = _ref.startDateTabIndex,
      ...
      endDateString = _ref.endDateString,
      endDateId = _ref.endDateId,
      endDateName = _ref.endDateName,
      endDatePlaceholderText = _ref.endDatePlaceholderText,
      endDateTabIndex = _ref.endDateTabIndex,
  ...
  return _react2['default'].createElement(
    'div',
    (0, _reactWithStyles.css)(styles.DateRangePickerInput, disabled && styles.DateRangePickerInput__disabled, isRTL && styles.DateRangePickerInput__rtl, !noBorder && styles.DateRangePickerInput__withBorder, block && styles.DateRangePickerInput__block, showClearDates && styles.DateRangePickerInput__showClearDates, (isStartDateFocused || isEndDateFocused) && styles.DateRangePickerInput__focused),
    ...
    showClearDates && _react2['default'].createElement(
      ...
      }, (0, _reactWithStyles.css)(styles.DateRangePickerInput_clearDates, small && styles.DateRangePickerInput_clearDates__small, !customCloseIcon && styles.DateRangePickerInput_clearDates_default, !(startDate || endDate) && !(startDateString || endDateString) && styles.DateRangePickerInput_clearDates__hide), {
