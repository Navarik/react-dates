    ...
    value: function () {
      function render() {
        ...
        var _props2 = this.props,
            ...
            onPrevYearClick = _props2.onPrevYearClick,
            onNextYearClick = _props2.onNextYearClick;
        var months = this.state.months;
        ...
        var width = isVertical || isVerticalScrollable ? calendarMonthWidth : (numberOfMonths * 3 + 2) * calendarMonthWidth;
        ...
        return _react2['default'].createElement(
          ...
          months.map(function (month, i) {
            var isVisible = i >= firstVisibleMonthIndex && i < numMonthsBeforeVisible + numberOfMonths;
            var hideForAnimation = i < numMonthsBeforeVisible && !isVisible;
            var showForAnimation = i < numMonthsBeforeVisible && isAnimating && isVisible;
            var monthString = (0, _toISOMonthString2['default'])(month);
            var showYearNav = i === firstVisibleMonthIndex + Math.ceil(numberOfMonths / 2) - 1;
            return _react2['default'].createElement(
              'div',
              _extends({
                key: monthString
