  ...
  _createClass(DateRangePickerInputController, [{
    ...
    value: function () {
      function onEndDateChange(endDateString) {
        ...
        this.setState({ endDateString: endDateString });
    ...
    value: function () {
      function onStartDateChange(startDateString) {
        ...
        this.setState({ startDateString: startDateString });
    ...
    value: function () {
      function render() {
        ...
        var startDateDisplayValue = this.getDateString(startDate);
        var endDateDisplayValue = this.getDateString(endDate);
