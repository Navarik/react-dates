  ...
  _createClass(DayPicker, [{
    ...
    value: function () {
      function onPrevMonthClick(nextFocusedDate, e) {
        ...
        var translationValue = this.isVertical() ? this.calendarMonthHeights[numberOfMonths] : calendarMonthWidth;

        if (this.isHorizontal()) {
          if (isRTL) {
            translationValue = -2 * calendarMonthWidth;
          }
          var newMonthHeight = Math.max.apply(Math, [0].concat(_toConsumableArray(this.calendarMonthHeights.slice(numberOfMonths, numberOfMonths * 2))));
    ...
    value: function () {
      function onNextMonthClick(nextFocusedDate, e) {
        ...
        var translationValue = this.isVertical() ? -this.calendarMonthHeights[numberOfMonths + 1] : -calendarMonthWidth;

        if (this.isHorizontal()) {
          if (isRTL) {
            translationValue = 0;
          }
          var newMonthHeight = Math.max.apply(Math, [0].concat(_toConsumableArray(this.calendarMonthHeights.slice(numberOfMonths + 2, numberOfMonths * 2 + 2))));
          this.adjustDayPickerHeight(newMonthHeight);
        }
    ...
    value: function () {
      function onNextYearClick(nextFocusedDate, e) {
        ...
        if (this.isHorizontal()) {
          ...
          var newMonthHeight = Math.max.apply(Math, [0].concat(_toConsumableArray(this.calendarMonthHeights.slice(numberOfMonths * 2 + 2))));
          this.adjustDayPickerHeight(newMonthHeight);
        }
    ...
    value: function () {
      function getFirstVisibleIndex() {
        ...
        var numMonthsBeforeVisible = numberOfMonths + 1;

        if (orientation === _constants.VERTICAL_SCROLLABLE) return 0;

        var firstVisibleMonthIndex = numMonthsBeforeVisible;
    ...
    value: function () {
      function getFocusedDay(newMonth) {
        var _props7 = this.props,
            getFirstFocusableDay = _props7.getFirstFocusableDay,
    ...
    value: function () {
      function updateStateAfterMonthTransition() {
        ...
        var _props8 = this.props,
            ...
            onNextYearClick = _props8.onNextYearClick,
            isRTL = _props8.isRTL;
